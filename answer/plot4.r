...
trimData$Voltage<-as.numeric(as.character(trimData$Voltage))
trimData$Global_reactive_power<-as.numeric(as.character(trimData$Global_reactive_power))
...
plot(trimData$Date,trimData$Voltage, type="l",main="",xlab="datetime",ylab="Voltage")
...
plot(trimData$Date,trimData$Global_reactive_power,ylab="Global_reactive_power",xlab="datetime",type="l")
